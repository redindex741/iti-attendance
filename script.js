...
window.showRecords = async function() {
  ...
  // Save last data globally for PDF export
...
async function downloadPdf(status) {
...
window.downloadPdf = downloadPdf; // expose to global for button onclick

// Continue with your existing script.js code for login, logout, addTrade, etc...
// Make sure to include full functions you have been using.
